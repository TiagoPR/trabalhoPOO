...
public class TesteTP {
    public static void main(String[] args) {
        ...
        GuardaRedes g1 = new GuardaRedes("Carlos",58,45,94,36,6,59,47,75);
        Lateral ld1 = new Lateral("Carlos",61,58,58,61,37,95,55,88);
        Defesa dc1 = new Defesa("Carlos",60,59,56,51,52,67,59,42);
        Defesa dc21 = new Defesa("Carlos",49,51,91,64,58,14,75,42);
        Lateral le1 = new Lateral("Carlos",53,62,56,64,0,92,59,14);
        Medio mc1 = new Medio("Carlos",68,66,96,74,69,57,76,61);
        Medio mc21 = new Medio("Carlos",67,73,61,72,73,54,43,4);
        Medio md1 = new Medio("Carlos",56,75,84,63,65,56,69,66);
        Medio me1 = new Medio("Carlos",59,3,1,88,52,54,72,66);
        Avancado ac1 = new Avancado("Carlos",68,31,13,65,30,61,71,70);
        Avancado ac21 = new Avancado("Carlos",90,73,56,60,41,72,53,63);
        ...
        Lateral ldb1 = new Lateral("Acácio",53,71,63,45,5,63,66,77);
        Defesa dcb1 = new Defesa("Acácio",58,72,52,51,61,57,51,60);
        Defesa dc2b1 = new Defesa("Acácio",40,58,24,70,53,54,89,65);
        Lateral leb1 = new Lateral("Acácio",71,58,70,0,71,73,84,50);
        Medio mcb1 = new Medio("Acácio",3,64,69,54,59,49,90,75);
        Medio mc2b1 = new Medio("Acácio",57,66,70,96,60,74,68,22);
        Medio mdb1 = new Medio("Acácio",89,63,59,66,60,50,25,40);
        Medio meb1 = new Medio("Acácio",28,64,54,87,21,83,82,72);
        Avancado acb1 = new Avancado("Acácio",55,54,8,93,94,70,68,60);
